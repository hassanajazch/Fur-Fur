...
$sql = "select registerid from uuiddowncounttable where  postid='$postid' AND uuid='$uuid'";
...
$s="DELETE FROM uuiddowncounttable WHERE postid='$postid' AND uuid='$uuid' ";
...
//echo "Norecord";
 ...
 $msql = "INSERT INTO uuiddowncounttable(postid, uuid,registerid)
